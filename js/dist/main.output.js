...
module.exports = {
	registration: {
		...
		chat: [
			'Hello!',
			'This app is designed to help people with functional neurological disorders.',
			'One of the main treatments is Cognitive Behavioural Therapy',
			...
			'I can help more by knowing a bit about you :)',
			'Whats your name?',
			'Great to meet you! Would you mind telling me how old you are?',
			'Thanks :)',
			'Let me tell you more about how this app works!',
			'It helps in two ways:',
			'When you have an episode, open the app and work through it with me.',
			'The animation on the homepage is designed to ground you.',
			'Breathe in while the shape is unfolding, breathe out while the shape refolds.',
			'Then repeat until you feel able to continue.',
			'Once you\'re ready, start a Spotlight session.',
			'We incorporate Cognitive Behavioural Therapy techniques to help you deal with an episode',
			'It\'s common to experience more than one symptom, but it\s most effective to focus on one at a time.',
			'This app also lets you create quick journal entries.',
			'They take less than a minute to complete, and help track your progress as you move up the waiting list.',
			...
			// },
			'Do you want to know more about how Cognitive Behavioural Therapy works?',
			// Yep!
	...
	spotlight: {
		...
		chat: [
			...
			'How could you change regarding your thoughts, emotions, physical experience or behaviour to make this better next time?',
